...
if(isset($_POST['request'])){
    ...
    // 1. Calculate Incoming Stock (Donations + Patient Offers)
    ...
    // 2. Calculate Outgoing Stock (Approved Requests)
    ...
    // If stock is okay, proceed to save the request
    $query = "INSERT INTO patient_blood_requests (patient_id, blood_group, units_required, reason, status) VALUES ($patient_id, '$blood_group', '$units', '$reason', 'Pending')";
...
<body>
    ...
    <div class="container mb-5">
        <div class="form-card">
            ...
            <p class="form-subtitle">We will try to fulfill your request as soon as possible.</p>
            <form method="post">
                ...
                <label class="font-weight-bold text-muted">Reason / Diagnosis</label>
                <textarea name="reason" class="form-control" placeholder="e.g. Urgent Surgery, Anemia, etc." rows="3" required></textarea>
