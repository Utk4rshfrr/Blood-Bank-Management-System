...
if(isset($_POST['register'])){
    ...
    if (!preg_match("/^[a-zA-Z\s]+$/", $name)) {
        ...
        $query = "INSERT INTO donors (name, email, password, blood_group, mobile, address) VALUES ('$name', '$email', '$password', '$blood_group', '$mobile', '$address')";
...
<body>
    <div class="reg-card">
        <h2 class="brand-text">Join as a Donor 🩸</h2>
        <p class="subtitle">Fill in your details to start saving lives.</p>
